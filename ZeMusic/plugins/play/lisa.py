...
def vgdg(client,message):
        message.reply_text(
            f"""✧ Welcome Baby,
ᴅᴇᴠᴇʟᴏᴘᴇʀ -› [Wissam ♪](t.me/R_j_Y)
ᴄʜᴀɴɴᴇʟ -› [𝘀𝗼𝘂𝗿𝗰𝗲 𝗹𝗶𝘀𝗮](t.me/sourcerona)""", 
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            "تحديثان ليزا 🍻", url=f"t.me/sourcerona")
                    ]
                ]
            ),
...
async def kstr(client: Client, message: Message):
       ...
       await message.reply_text(
        f"""- **ابشر ياعيوني ارسلت للمطور بيخش القروب ويشوف مشكلتك بأقرب وقت\n\n- تابع قناة البوت عشات تشوف التحديثات** -› [• Source Lisa •](t.me/sourcerona)""", disable_web_page_preview=True     
    )
...
2 • لو تبي تشوف الاوامر اكتب [ م الاوامر ] ولو تبي تشغل على طول اكتب ليزا شغل + اسم المقطع الصوتي
• مثال : ليزا شغل واتنسيت
- لو واجهت مشكله كلم مطور البوت ~ @R_j_Y""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
                    InlineKeyboardButton(
                       "Wissam", user_id=2089102006),
                ],[
                    InlineKeyboardButton(
...
مطور السورس -› [Wissam](t.me/R_j_Y)
قناة السورس -› [source Lisa](t.me/sourcerona)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
...
• AppleMusic
• Spotify
- لو واجهت مشكلة تواصل مع مطور السورس @R_j_Y**
- [source Lisa](t.me/sourcerona)
""",
        reply_markup=InlineKeyboardMarkup(
            [
                [
